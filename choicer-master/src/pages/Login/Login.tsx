  ...
  return (
      <div className="login">
        <div className="login-information">
          ...
          <p className="login-information__text p2--light">Данное приложение разработано для Финансового университета при Правительстве РФ
          </p>
          <p className="p2--light">
            Здесь Вы можете просматривать курсовые, дипломные работы, проекты, а так же подать заявки на их написание.
          </p>
        </div>
